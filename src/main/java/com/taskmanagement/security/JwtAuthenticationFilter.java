...
/**
 * Runs once per request, extracts a {@code Bearer} JWT from the
 * {@code Authorization} header, validates it and — if valid — populates the
 * {@link SecurityContextHolder} so downstream authorization checks work.
 */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            ...
            // falls through as unauthenticated and is handled by the entry point.
